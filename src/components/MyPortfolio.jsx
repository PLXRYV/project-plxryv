        ...
        <div className="myportfolio-container">
            ...
            <div className="myportfolio-item">
                ...
                <div className="myportfolio-description">
                    ...
                    <img className="portfolio-item-icon" src="/src/assets/icons/icons-html.png" alt="HTML"></img>
                    <img className="portfolio-item-icon" src="/src/assets/icons/icons-css.png" alt="CSS"></img>
                    <img className="portfolio-item-icon" src="/src/assets/icons/icons-sass.png" alt="SASS"></img>
                    <img className="portfolio-item-icon" src="/src/assets/icons/icons-javascript.png" alt="JavaScript"></img>
                    <img className="portfolio-item-icon" src="/src/assets/icons/icons-react.png" alt="React"></img>
                    <img className="portfolio-item-icon" src="/src/assets/icons/icons-vite.png" alt="Vite"></img>
                    <img className="portfolio-item-icon" src="/src/assets/icons/icons-node-js.png" alt="Node.JS"></img>
                </div>
            </div>
            <div className="myportfolio-item">
                ...
                <div className="myportfolio-description">
                    ...
                    <img className="portfolio-item-icon" src="/src/assets/icons/icons-html.png" alt="HTML"></img>
                    <img className="portfolio-item-icon" src="/src/assets/icons/icons-sass.png" alt="SASS"></img>
                    <img className="portfolio-item-icon" src="/src/assets/icons/icons-react.png" alt="JavaScript"></img>
                    <img className="portfolio-item-icon" src="/src/assets/icons/icons-node-js.png" alt="Node.JS"></img>
                    <img className="portfolio-item-icon" src="/src/assets/icons/icons-vite.png" alt="Vite"></img>
                </div>
            </div>
